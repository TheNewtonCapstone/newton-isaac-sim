...
class KLAdaptiveLRCustom(KLAdaptiveLR):
    def __init__(
        self,
        ...
        The implementation is adapted from the *rsl-rl* library.
        ...
        Example::
            ...
            >>> scheduler = KLAdaptiveLRCustom(optimizer, kl_threshold=0.01)
    ...
    def step(
        self,
        kl: Optional[Union[torch.Tensor, float]] = None,
        ...
        if kl is not None:
            for group in self.optimizer.param_groups:
                ...
                elif self.kl_threshold / self._kl_factor > kl > 0.0:
