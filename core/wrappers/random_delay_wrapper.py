...
class RandomDelayWrapper(BaseTaskWrapper):
    ...
    def reset(self) -> VecEnvObs:
        ...
        assert self.t == 0
        received_observation, *_ = self._receive_observation()
    ...
    def step_wait(self) -> VecEnvStepReturn:
        ...
        if self.t < self.act_delay_range.stop:
            ...
            action_delay = self._receive_action()
        ...
        # at the brain again
        m, *delayed_aux = self._receive_observation()
